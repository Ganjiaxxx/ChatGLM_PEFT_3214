...
class Trainer():
    ...
    def __init__(self, tokenizer, config, from_pretrained, reward_from_pretrained, loader_name, data_path, ratio_for_rlhf=0.4, actor_resume_path=None, critic_resume_path=None, critic_layers_keep=1, max_length=512, batch_size=1, batch_size_eval=2, eval_mode='test', task_name='Sim'):
    ...
    def train(self, resume_step=None, num_epochs=30, lr=1e-4, num_beams=3, num_return_sequences=2, eval_call_epoch=None, ppo_epochs=5):
        ...
        for epoch in range(num_epochs):
            ...
            # eval_call_epoch 为None ==> 一轮跑一次eval
